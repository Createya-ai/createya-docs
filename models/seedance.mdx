---
title: 1.5 Pro
description: Move. Dance. Create.. Генерация через Createya API — без VPN, оплата в рублях. Seedance ByteDance API, генерация видео.
sidebar:
  label: 1.5 Pro
---
...
📚 [Полный обзор модели на createya.ai](https://createya.ai/knowledge/seedance)
...
r = requests.post(
    ...
    json={"model": "seedance", "input": {"prompt": "your prompt"}}
)
print(r.json())
```
