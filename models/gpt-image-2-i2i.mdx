...
**Стоимость:** 50 кредитов / запрос (quality: low=6кр, medium=16кр, high=50кр; image_size: 2–102кр (18 вариантов); × num_images (1–4)).
...
r = requests.post(
    ...
    json={"model": "gpt-image-2-i2i", "input": {"prompt": "your prompt"}}
)
print(r.json())
```
