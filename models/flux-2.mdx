---
title: 2
description: See More. Create Better.. Генерация через Createya API — без VPN, оплата в рублях. Flux 2 API на русском, генерация изображений Flux, Flux Kontext редактирование.
sidebar:
  label: 2
---
...
📚 [Полный обзор модели на createya.ai](https://createya.ai/knowledge/flux-2)
...
r = requests.post(
    ...
    json={"model": "flux-2", "input": {"prompt": "your prompt"}}
)
print(r.json())
```
