...
r = requests.post(
    ...
    json={"model": "kling-video-o3-std-r2v", "input": {"prompt": "your prompt"}}
)
print(r.json())
```
...
| `duration` | enum |  | Video duration in seconds (3-15s). |
| `shot_type` | string |  | The type of multi-shot video generation. |
| `aspect_ratio` | enum |  | The aspect ratio of the generated video frame. |
